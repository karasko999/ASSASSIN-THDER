...
sleep 3
cp Karasko333.flf $PREFIX/share/figlet/Karasko333.flf;
...
bash ~/assassin-thder/.banner.sh ${col} ${TNAME}
echo "";
...
if [[ ${PROC32} == [Y/y] ]]; then
	...
	if [ -d $HOME/assassin-thder ]; then
	cd $HOME/assassin-thder
	fi
...
echo -e "\e[1;32m
+----------------------------------*/
Karasko333 : (\e[33m14.4.2021\e[32m)

1. TEAM ASSASSIN IS BACK
2. BIG ASSASSIN [KARASKO] (\e[33mplugins\e[01;32m)
3. FREE PHALSTIN (\e[33mplugins\e[01;32m)
4. Terminal-Header
...
ozsh=0
if [ -d $HOME/.TEAM ASSASSIN IS BACK ]; then
	(rm -rf $HOME/.TEAM ASSASSIN IS BACK/) &> /dev/null
...
while [ $ozsh = 0 ];
do
	echo -e "\e[1;34m[*] \e[32TEAM ASSASSIN IS BACK new setup....\e[0m";
	echo "";
